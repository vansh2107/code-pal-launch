...
Format your response as a JSON array of objects with this structure:
{
  "suggestions": [
    ...
    if (analysisType === "classify") {
      systemPrompt = "You are an expert document classification AI with deep knowledge of international document types, legal requirements, and categorization standards. You must accurately categorize documents into specific types.";
